        ...
        <div class='indexwrap'>
            <div class='searchform'>
                <div class='searchwrap'>
                    ...
                    <div class="">
                        <form action="{{ route('adminlivehouseindex') }}" method="GET">
                            @csrf
            ...
            @foreach($bandusers as $banduser)
                <div class="bandshow">
                     <div class="bandshowwrap">
                        <div class="showimage">
                            <a href='/adminbandshow/{{ $banduser->id }}'><img src="{{ '/storage/' . $banduser->image }}" class='artistimage'></a>
                        </div>
                        <a href='/adminbandshow/{{ $banduser->id }}'>{{ $banduser->name }}</a><br>
