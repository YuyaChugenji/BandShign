    ...
    <div class='indexwrap'>
        <div class='searchform'>
            <div class='searchwrap'>
                <div class="">
                    <form action="{{ route('adminbandindex') }}" method="GET">
                        @csrf
            ...
            <div class='searchwrap2'>
                ...
                <div class="bandshow">
                    <div class="bandshowwrap">
                        <div class="showimage">
                            <a href='/adminlivehouseshow/{{ $livehouseuser->id }}'><img src="{{ '/storage/' . $livehouseuser->image }}" class='artistimage'></a>
                        </div>
                        <a href='/adminlivehouseshow/{{ $livehouseuser->id }}'>{{ $livehouseuser->name }}</a><br>
