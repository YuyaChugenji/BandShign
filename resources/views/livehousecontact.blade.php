	...
	<body>
        <div class='wrap'>
            <div class='signupform'>
                <div class='signform'>
                    <div class='signtext'>
                        <h2>{{ $livehouseuser->name }}へお問合せをする</h2>
                    </div>
                        <form action="./bandcontact" method="post" id="form">
                        @csrf
                        <input id="id" type="hidden" name="id" value="{{ $livehouseuser->id }}">
                        <input id="sendemail" type="hidden" name="sendemail" value="{{ $livehouseuser->email }}">
                        <div class='signname'>
                            <label>名前</label>
